...
set shortmess=aoO
badd +0 R/get_data.r
badd +0 inst/scratch_work/save_query_as_string.r
badd +0 inst/scratch_work/draft1.r
...
exe 'vert 1resize ' . ((&columns * 83 + 105) / 211)
exe '2resize ' . ((&lines * 35 + 37) / 74)
exe 'vert 2resize ' . ((&columns * 127 + 105) / 211)
exe '3resize ' . ((&lines * 36 + 37) / 74)
exe 'vert 3resize ' . ((&columns * 83 + 105) / 211)
exe '4resize ' . ((&lines * 36 + 37) / 74)
exe 'vert 4resize ' . ((&columns * 43 + 105) / 211)
argglobal
...
wincmd w
argglobal
edit inst/scratch_work/save_query_as_string.r
vnoremap <buffer> <silent> \rd :call RSetWD()
vnoremap <buffer> <silent> \ko :call RMakeRmd("odt")
vnoremap <buffer> <silent> \kh :call RMakeRmd("html_document")
vnoremap <buffer> <silent> \kw :call RMakeRmd("word_document")
...
wincmd w
argglobal
edit inst/scratch_work/draft1.r
vnoremap <buffer> <silent> \rd :call RSetWD()
nnoremap <buffer> <silent> \rd :call RSetWD()
onoremap <buffer> <silent> \rd :call RSetWD()
vnoremap <buffer> <silent> \ko :call RMakeRmd("odt")
